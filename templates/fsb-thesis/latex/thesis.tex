...
% Dual-engine font/encoding (vidi seminar.tex / gotcha miktex-t1-bold-diacritics).
% Tectonic (XeTeX) je kanonski: fontspec + TeX Gyre Termes ima pravi OpenType bold
% pa hrvatski ž/ć/š/đ rade i u \textbf{}. NE mathptmx (gubi bold za T1 dijakritike).
\usepackage{iftex}
\ifPDFTeX
  \usepackage{cmap}
...
\usepackage{amsmath}
\usepackage{amssymb}
% Font je postavljen u iftex bloku gore (TeX Gyre Termes / newtxtext).
